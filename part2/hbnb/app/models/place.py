...
DEFAULT_PHOTO_URL = "https://depositphotos.com/vector/default-avatar-profile-icon-vector-social-media-user-photo-image-668841706.html"
class Place(BaseModel):
    ...
    def add_photo(self, url):
        if DEFAULT_PHOTO_URL in self.photos:
            self.photos.remove(DEFAULT_PHOTO_URL)
    ...
    def remove_photos(self, url):
        ...
        if not self.photos:
            self.photos.append(DEFAULT_PHOTO_URL)
        self.updated_at = datetime.now(timezone.utc)
